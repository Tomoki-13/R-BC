...
describe('funcNameIdentifiers.ts test', () => {
  ...
  const filePath2: string = "./src/__tests__/inputFiles/functionSample/funcsample3.ts";
  const filePath3: string = "./src/__tests__/inputFiles/import_require_Sample/importsample.ts";
  const filePath4: string = "./src/__tests__/inputFiles/import_require_Sample/requiresample.js";
