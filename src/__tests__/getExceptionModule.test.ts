...
describe('getExceptionModule', () => {
  const filePath1: string = "./src/__tests__/inputFiles/getExceptionModule/sample1.js";
  const filePath2: string = "./src/__tests__/inputFiles/getExceptionModule/sample2.js";
